...
public class DataLoader implements ApplicationRunner {
    ...
    public void insertUsers() {
        ChatUser chatUser1 = new ChatUser("user0", "ditrim023@ukr.net", Gender.MALE,new BCryptPasswordEncoder(10).encode("123456"));
        chatUser1.setRole(userRoleRepository.findOne(1L));
        chatUsers.add(chatUser1);
        ChatUser chatUser2 = new ChatUser("Naram", "ditrim020@ukr.net", Gender.FEMALE,new BCryptPasswordEncoder(10).encode("123456"));
